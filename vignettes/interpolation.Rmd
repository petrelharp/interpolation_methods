...
```{r test-best-with-cv}
xbest <- automatic_inverse_interpolation(xx, yy, yref, min_omega=.75, max_omega=1, seed=111)
stopifnot(xbest$boundary_value)
xbest <- automatic_inverse_interpolation(xx, yy, yref, min_omega=.0001, max_omega=1, seed=111)
stopifnot(!xbest$boundary_value)
```
